...
$('.editCategorieImage').click(function () {
    var position = $(this).position();
    var subForId = $(this).data('sub-for-id');
    $('[name="ImageEditorCatID"]').val(subForId);
    $('#ImageEditor').css({top: position.top, left: position.left, display: 'block'});
});

$('.saveCategoryImage').click(function ()
{
    $('#categorieEditImage').submit();
});
