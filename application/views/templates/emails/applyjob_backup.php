...
<html>
                ...
                <div  style="background-color: #fbfcfd; border-top: thick double #cccccc; text-align: left;">
                    <div style="margin: 30px;">
                        <p>
                            ...
                            We have received your request to this job. We will response after screen your account. Here are your details:<br><br>
                        </p>
                        <table style="text-align: left;">
                            ...
                            <tr>
                                <th>Job</th>
                                <td>: <?=$profile[0]->job_title;?></td>
                            </tr>
                            <tr>
                                <th>Job Type</th>
                                <td>: <?=$profile[0]->job_type;?></td>
                            </tr>
                            <tr>
                                <th>Job</th>
                                <td>: <?=$profile[0]->name;?></td>
                        ...
                        <br>  <br>
                            ...
                            Here is the link to access your area: <a href='.home_url().' target="_blank">LINK</a><br><br>
        ...
        <center>2017 © CTM. ALL Rights Reserved.</center>
        </body>
    </html> 