                ...
                <div  style="background-color: #fbfcfd; border-top: thick double #cccccc; text-align: left;">
                    <div style="margin: 30px;">
                        <p>
                            ...
                            We have a received a request for your "Service Title". Please Login to check the details<br><br>
                        </p>
                        <br> <br>
                        <a href="<?php echo base_url(); ?>/employer/login" target="_blank" style="background-color:#f4bc33;color:black;padding:13px;">Login</a>
                        <br>  <br>                      
                            Here is the link to access your area: <a href='<?php echo base_url(); ?>/myaccount/services/id' target="_blank">View Job</a><br><br>
